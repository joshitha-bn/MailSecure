...
function LoginForm({ onSwitchMode }: { onSwitchMode?: (mode?: "signup" | "forgot") => void }) {
      ...
      <div className="auth-card">
        ...
        <div className="auth-form">
          ...
          <div style={{ textAlign: "right", marginTop: "6px" }}>
            <button
              type="button"
              onClick={() => onSwitchMode ? onSwitchMode("forgot") : router.push("/forgot-password")}
          ...
          <div className="auth-button-row" style={{ marginTop: "24px", flexDirection: "column", gap: "12px" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", width: "100%" }}>
              <button
                type="button"
                onClick={() => onSwitchMode ? onSwitchMode("signup") : router.push("/login?mode=signup")}
